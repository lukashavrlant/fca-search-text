...
\begin{enumerate}
	...
	\item Jednotlivé návrhy poté nalezneme v intentech okolních konceptů. Specializaci nalezneme ve spodních sousedech, generalizaci v horních sousedech a podobné dotazy v sosuedních konceptech. Pokud například koncept dotazu má intent $\adds{\mbox{limita, funkce}}$ a nějaký spodní soused má intent $\adds{\mbox{limita, funkce, vlastní}}$, odvodíme z toho specializaci \code{+vlastní}. 
\end{enumerate}
...
V extentech $G_1$ a $G_2$ jsou jednotlivé dokumenty, ideou tak je, že nejrelevantější návrh by měl zároveň vést na nejvíce dokumentů. 
