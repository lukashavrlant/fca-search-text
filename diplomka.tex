...
\begin{eqnarray}
&&A_1\subseteq A_2\implies f(A_2)\subseteq f(A_1)\\
...
\begin{theorem}[Zřetězení Galoisových spojení]
...
\begin{mydef}[Uzávěrový operátor]
...
\begin{theorem}[Od Galoisova spojení k uzávěrovému operátoru]
...
K tomu, abychom dokázali, že $\addsp{\lattice, \le}$ je skutečně svaz, musíme dokázat, že pro každé dva koncepty $c_1, c_2\in\addsp{\lattice, \le}$ existuje v tomto svazu jejich supremum a infimum. 
