...
%%% Používané funkce
\DeclareMathOperator{\tdidf}{td-idf}
...
\begin{itemize}
\item Seznam všech klíčových slov všech dokumentů v sadě spolu s jejich $\tdidf$ skórem vzhledem k danému dokumentu. V dalších algoritmech budeme potřebovat vědět, zda dokument $d$ obsahuje klíčové slovo $k$, případně i jaké je jeho $\tdidf$ skóre. 
...
\item Meta data ke všem dokumentům. Jedná se o:
	...
	\item URL dokumentu. 
	\item Klíčová slova daného dokumentu spolu s jejich $\tdidf$ skórem. 
