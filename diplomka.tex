...
\begin{itemize}
	\item \url{https://github.com/havrlant/fca-search/wiki/dokumentace}
\end{itemize}
Zdrojové kódy webového rozhraní se nachází na adrese
\begin{itemize}
	\item \url{https://github.com/havrlant/fca-seach-web}
\end{itemize}
Dokumentace, popis všech možností nastavení a popis API webového rozhraní se nachází na wiki stránce
\begin{itemize}
	\item \url{https://github.com/havrlant/fca-seach-web/wiki/dokumentace}
\end{itemize}
...
\begin{description}
	...
	\item[src/] Adresář obsahuje zdrojové kódy aplikace. Protože aplikace nemá žádné spustitelné soubory, nachází se zde stejné archivy jako v adresáří \code{bin/}. 
	\item[readme.txt] V tomto souboru je stručný popis toho, kde je současná verze nainstalována, jak ji používat a odkazy na dokumentaci. 
\end{description}
