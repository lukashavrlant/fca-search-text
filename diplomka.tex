...
\name{} is a prototype of a web search engine that works with static set of documents. It can process several types of documents, extracts a title and a description of a document, checks typing errors and the result set of documents is ordered by relevance. 
