...
\begin{description}
	...
	\item[src/] Adresář obsahuje zdrojové kódy aplikace. Protože aplikace nemá žádné spustitelné soubory, nachází se zde stejné archivy jako v adresáři \code{bin/}. 
	\item[readme.html] V tomto souboru je stručný popis toho, kde je současná verze nainstalována, jak ji používat a odkazy na dokumentaci. 
\end{description}
