...
\usepackage[master]{styly/updiplom}
...
\item Je-li $Q = \alpha \AND \beta$, pak $\getdocs(Q) = \getdocs(\alpha) \cap \getdocs(\beta)$.
\item Je-li $Q = \alpha \OR \beta$, pak $\getdocs(Q) = \getdocs(\alpha) \cup \getdocs(\beta)$.
\item Je-li $Q = \NOT \alpha$, pak $\getdocs(Q) = \mathbb{D}\setminus\getdocs(\alpha)$, kde $\mathbb{D}$ je množina všech dokumentů.
\end{itemize}
