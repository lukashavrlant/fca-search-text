...
\addsp{x,y} \in I \iff y \in x.
$$
Tento rozšířený kontext si označíme $\addsp{X', Y', I'}$. Postup nalezení Hledaného konceptu se nijak nemění, pouze použijeme tento kontext, namísto původního $\context$.
