...
Further research can be done in the following areas: document processing like improve attributes searching, improve stemmer, search for synonym etc. We can use fuzzy FCA instead of crisp FCA. We can use information about word importance to build a new fuzzy formal context. We can extend API and build some new applications that use it. 
\end{conclusions-en}
