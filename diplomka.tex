...
\begin{itemize}
	\item Pro dotaz \uv{hosting} vrátí seznam specializací \code{+ php | + serveru | + seo | + google | + weblogu | + domény | + anglicky | + základní | + software | + firmy}. 
	\item Pokud přidáme slovo \uv{php}, dostaneme nový seznam specializací \code{+ serveru | + knihy | + google | + faq | + weblogu | + díky | + xml | + testování | + seo | + anglicky} a seznam podobných dotazů: \code{+/- hosting, serveru | +/- google, hosting | +/- knihy, php | +/- php, google | +/- php, serveru}.
\end{itemize}
